...
public class UserManagement {
        ...
        while(isContiue){
            ...
            switch(chance){
                ...
                case 3:
                    ...
                    newUser = new User(str,queryUser(str).getSex(),queryUser(str).getIdentity(),MD5encipher.getMD5Str("**********"));
                    updateUser(newUser);
    ...
    public static void initializeUser() {
        ...
        userList=TxtAction.readUserFromFile("user.txt");
        if(userList==null || userList.isEmpty()){//如果该文件读出为空，将预设的信息导入userList和文件
            ...
            TxtAction.writeUserToFile(userList, "user.txt");
        }
        else //用户文件不空则直接读出
            userList=TxtAction.readUserFromFile("user.txt");
    }
